...
<table class="table">
  ...
  <tbody>
     ...
     <tr>
      ...
      <td><a href="<?php echo BASE_URL?>/post/delete_post/<?php echo $value['id_category_post']?>">Xóa</a></td>
      <td><a href="<?php echo BASE_URL?>/post/edit_post/<?php echo $value['id_category_post']?>">Cập nhật</a></td>
    </tr>
    <?php 
    }
    ?>
