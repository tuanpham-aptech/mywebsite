                     ...
                     <table class="table table-hover table-condensed">
                        ...
                        <form action="<?php echo BASE_URL?>/ordercartuser" method="post">
                           ...
                           ?>
                              <tr class="tr">
                                 <td data-th="Hình ảnh">
                                    <div class="col_table_image col_table_hidden-xs"><img src="<?php echo BASE_URL?>public/uploads/product/<?php echo $value['product_image']?>" 
                           ...
                           <tr>
                              <td colspan="7" class="textright_text">
                                 <div class="sum_price_all">
                                    ...
                                    <span class="text_price color_red">  <?php echo number_format($total,0,',','.')?></span>
                                 </div>
                              </td>
                           </tr>
                        ...
                        <div class="ch-contacts-details">
                           ...
                           <div class="hiring-box">
                              ...
                              <p>Mọi thắc mắc bạn hãy gửi về mail của chúng tôi 
                                 <strong>tuan.pv.782@aptechlearning.edu.vn.</strong></p>
