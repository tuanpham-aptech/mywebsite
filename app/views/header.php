            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item active dropdown">
                     ...
                     <div class="dropdown-content" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="<?php echo BASE_URL?>categoryproduct/category_product/<?php echo $value['id']?>">
                        <?php echo $value['name']?>
                        </a>
                        <?php } ?>
                     </div>
                  ...
                  <li class="nav-item active dropdown">
                     ...
                     <div class="dropdown-content" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="<?php echo BASE_URL?>brand/brand_product/<?php echo $br['id_brand']?>">
               ...
               <ul class="form-inline my-2 my-lg-0 list-unstyled">
                  <li class="nav-item mr-4">
                     <a class="nav-link text-warning display-4" href="http://localhost:81/mywebsite/ordercartuser"><i class="fas fa-cart-plus ml-2"></i></a>
                  </li>
